...
namespace csc232
{
    ...
    TEST_F(Task1TestFixture, ItDeclaredGetIndexOf)
    {
        EXPECT_TRUE(isMethodDeclaredInClass("./ArrayBagRecursive.h", "csc232", "ArrayBagRecursive", "getIndexOf"));
    }

    TEST_F(Task1TestFixture, ItDeclaredCountFrequency)
    {
        EXPECT_TRUE(isMethodDeclaredInClass("./ArrayBagRecursive.h", "csc232", "ArrayBagRecursive", "countFrequency"));
    }
